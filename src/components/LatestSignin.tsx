  ...
  return (
    <div className=' min-h-screen flex items-center justify-center bg-black p-4'>
      <div className='w-full max-w-4xl flex flex-col items-center '>
        ...
        <div
          className='border-black border-4 w-full max-w-md rounded-lg overflow-hidden bg-black transform hover:scale-[1.02] transition-transform
  shadow-[5px_5px_0px_0px_rgba(109,40,217),10px_10px_0px_0px_rgba(109,40,217,0.6)]'
        >
          <div className='p-8'>
            <h3 className='text-3xl font-bold mb-6 text-center text-gray-400'>
              Sign In
            </h3>
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <button
                type='submit'
                disabled={isLoading}
                className={`w-full bg-indigo-500 text-yellow-50 font-bold py-3 px-4 rounded-lg hover:bg-indigo-700 hover:text-white 
                transition-all duration-300 transform hover:scale-95 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50
                   ${
                     isLoading
            ...
            <Link to='/signup'>
              <p className='mt-6 text-sm text-gray-400 text-center'>
                ...
                <h5 className='font-semibold underline hover:text-indigo-600'>
                  Sign up here
                </h5>
              </p>
            </Link>
